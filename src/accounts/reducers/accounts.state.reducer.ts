...
import { AccountsReducerAction, AccountsReducerState, DefaultAccountsReducerState } from '../types/accounts.data.types';

const initialState = DefaultAccountsReducerState;

export default function accounts(state = initialState, action: Partial<AccountsReducerAction>): AccountsReducerState {
  switch (action.type) {
